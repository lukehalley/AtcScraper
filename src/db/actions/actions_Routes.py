...
def addRouteToDB(networkDbId, dexDbId, pairDbId, tokenInDbId, tokenInAddress, tokenOutDbId, tokenOutAddress, route, method, transactionHash,
                 txTimestamp, blockNumber, amountIn, amountOut):

    keys = f"network_id, dex_id, pair_id, token_in_id, token_in_address, token_out_id, token_out_address, route, method, transaction_hash, block_number, "
